...
static var GAN_GEN2_COMMAND_CHARACTERISTIC : String = "28be4a4a-cd67-11e9-a32f-2a2ae2dbcce4";
# GAN Gen2 protocol BLE state characteristic
static var GAN_GEN2_STATE_CHARACTERISTIC : String = "28be4cb6-cd67-11e9-a32f-2a2ae2dbcce4";

# GAN Gen3 protocol BLE service
static var GAN_GEN3_SERVICE : String = "8653000a-43e6-47b7-9cb0-5fc21d4ae340";
# GAN Gen3 protocol BLE command characteristic
static var GAN_GEN3_COMMAND_CHARACTERISTIC : String = "8653000c-43e6-47b7-9cb0-5fc21d4ae340";
# GAN Gen3 protocol BLE state characteristic
static var GAN_GEN3_STATE_CHARACTERISTIC : String = "8653000b-43e6-47b7-9cb0-5fc21d4ae340";

# GAN Gen4 protocol BLE service
static var GAN_GEN4_SERVICE : String = "00000010-0000-fff7-fff6-fff5fff4fff0";
# GAN Gen4 protocol BLE command characteristic
static var GAN_GEN4_COMMAND_CHARACTERISTIC : String = "0000fff5-0000-1000-8000-00805f9b34fb";
# GAN Gen4 protocol BLE state characteristic
static var GAN_GEN4_STATE_CHARACTERISTIC : String = "0000fff6-0000-1000-8000-00805f9b34fb";

static func is_gan_cic(cic : int) -> bool:
	return cic >= 0x0001 && cic <= 0xFF01

#  List of encryption keys
static var GAN_ENCRYPTION_KEYS = [
